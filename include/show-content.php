...
//    var_dump(strpos($fontsize, "px"));
    ...
    $style = "<style>
            ...
            $style_italic
              ...
              <!--[if IE]>
            	<link href='" . WPTEXT2AD_PLUGIN_URL . "/wptext2ad/library/bubbletip/js/bubbletip/bubbletip-IE.css' rel='stylesheet' type='text/css' />
            <![endif]-->";
    echo $style;
        ...
        if ($result) {
            ...
            if ($mp3) {
                $addtional_script = ' var flashvars = {  ' . $mp3 . '	};
                            		...
                            		swfobject.embedSWF("' . WPTEXT2AD_PLUGIN_URL . '/wptext2ad/library/audio/Playaudio.swf", "altContent", "0", "0", "10.0.0", "' . WPTEXT2AD_PLUGIN_URL . '/wptext2ad/library/audio/expressInstall.swf", flashvars, params, attributes);
                ';
...
function add_jquery() {
    ...
    wp_enqueue_script('jquery_conflict', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/js/jquery_conflict.js');
    wp_enqueue_script('jscolor', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/library/jscolor/jscolor.js', array(), NULL, false);
    wp_enqueue_script('wptext2adscript', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/js/script.js');
    wp_enqueue_script('bubbletip', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/library/bubbletip/js/jQuery.bubbletip-1.0.6.js');
    wp_enqueue_script('swfobject', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/library/audio/js/swfobject.js');
    wp_enqueue_script('jquery-actual', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/js/jquery.actual.min.js');
    wp_enqueue_script('soundmanager2', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/library/soundmanager/script/soundmanager2-nodebug-jsmin.js');
    wp_enqueue_script('sound_extra', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/js/sound_extra.js');
}
