...
function init_WpText2Ad_power() {
    wp_enqueue_style('wpTextbubbletipcss', WPTEXT2AD_PLUGIN_URL . "/wptext2ad/library/bubbletip/js/bubbletip/bubbletip.css");
    wp_enqueue_style('wpTextbubbletipcss');

    wp_enqueue_style("wpTextstyle", WPTEXT2AD_PLUGIN_URL . "/wptext2ad/style/wptext2ad_style.css");
