                ...
                wptext2adjq(document).ready(function(){
                    ...
                    if(wptext2adjq("#textadtype").val()!=""){
                        ...
                        if(wptext2adjq("#textadtype").val()==1){
                            ...
                            swfobject.embedSWF("<?php echo WPTEXT2AD_PLUGIN_URL; ?>/wptext2ad/library/audio/Playaudio.swf", "altContent", "0", "0", "10.0.0", "<?php echo WPTEXT2AD_PLUGIN_URL; ?>/wptext2ad/library/audio/expressInstall.swf", flashvars, params, attributes);
                        ...
                        <div id="audio" class="cityBox">
                            ...
                            <?php if ($list_result->url) { ?>
                                ...
                                <div class="exBox">
                                    ...
                                    <a id="startAudio" href="javascript:void(0)"><img src="<?php echo WPTEXT2AD_PLUGIN_URL; ?>/wptext2ad/images/start.png" /></a> 


                                    <a  href="javascript:void(0)" id="stopAudio"><img src="<?php echo WPTEXT2AD_PLUGIN_URL; ?>/wptext2ad/images/stop.png" /></a>
