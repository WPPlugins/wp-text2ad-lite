...
if (!defined("WPTEXT2AD_MY_PLUGIN_DIR"))
    define("WPTEXT2AD_MY_PLUGIN_DIR", WPTEXT2AD_CONTENT_DIR . "/plugins/wptext2ad");
...
function WpText2Ad_jsAdd() {
    ...
    wp_enqueue_script('jscolor', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/library/jscolor/jscolor.js');
    ...
    wp_enqueue_script('flowplayer', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/js/flowplayer/flowplayer-3.2.6.min.js');
    wp_enqueue_script('flowplayer_extra', WPTEXT2AD_PLUGIN_URL . '/wptext2ad/js/flowplayer_scripts.js');
}
...
//        add_action("admin_notices", array(&$this, "wptext2ad_warning"));
        add_menu_page(__("WP Text2Ad"), __("WP Text2Ad"), $WpText2Ad_plugin_access, "wptext2ad_license", $request_handler, WPTEXT2AD_PLUGIN_URL . "/wptext2ad/images/logo.png");
        ...
        <div id="pagewrap">
            ...
            <div id="menubar">
                ...
                <div id="bar">
                    ...
                    <a href=""><img src="<?php echo site_url(); ?>/wp-content/plugins/wptext2ad/images/menubg.png" alt="bar" height="50px"/></a>
                </div>
